...
tab_model(lmm.all.optimized, pred.labels = c("Intercept","Age Group","Cloze Probability","Visual Mask","Acoustic Mask","Trial order", "Acoustic * Visual Mask","Acoustic * Cloze Probability", "Cloze Probability*Age Group"),
          file = "figure/220213RTfull.html")
          webshot("figure/220213RTfull.html", "figure/220213RTfull.png")
...
emmip(lmm.adults.optimized,~AUDIO*VIDEO)
emmip(lmm.adults.optimized,VIDEO~AUDIO)

#Audio:predict
emmeans(lmm.adults.optimized,pairwise~AUDIO*PREDICT)
emmip(lmm.adults.optimized,~AUDIO*PREDICT)
emmip(lmm.adults.optimized,PREDICT~AUDIO)
```
...
## tab model rearranged 
```{r}
tab_model(lmm.adults.optimized,lmm.children.optimized)

tab_model(lmm.adults.optimized,lmm.children.optimized, pred.labels = c("Intercept","Acoustic Mask","Visual Mask","Cloze Probability","Age Group","Trial Order","Acoustic * Visual", "Acoustic * Cloze Probability", "Age Group* Cloze Probability"),
